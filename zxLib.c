...
static void assertLaser(int type, int step) {
    switch (type) {
        ...
        case laserDuring2Terice:
            if (step == atDelay1sToMiddle) {
                turnOnLaser(laser.side);
            } else if (step == atDelayMid500mSec) {
                turnOffLaser();
            }
            break;
            ...
            if (interOdorDelay < 4) {
                ...
                if (taskType == DUAL_TASK_LEARNING || taskType == DUAL_TASK
                    ...
                    if (interOdorDelay <= 10u) {
                        ...
                        waitTimerJ(450u); //distractor@6sec
                    }
